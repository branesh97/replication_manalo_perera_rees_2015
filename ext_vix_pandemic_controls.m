...
%% VIX matched sample: 1990Q1 to 2026Q2

sample_vix = (yearlab >= 1990) & (yearlab <= 2026 + 1/4);
...
% (3) Pandemic controls
d_2020q2 = double(yearlab_vix == 2020 + 1/4);
d_2021q3 = double(yearlab_vix == 2021 + 2/4);

d = [d_it ...
     d_2008q4 d_2009q1 d_2009q2 d_2009q3 ...
     d_2020q2 d_2021q3]; % for pandemic shocks
