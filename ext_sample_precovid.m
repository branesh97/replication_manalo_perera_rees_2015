...
%% Extended sample: 1985Q1 to 2019Q4

sample_ext = (yearlab >= 1985) & (yearlab <= 2019 + 3/4);
...
fprintf('\nExtended-sample (pre-COVID) exchange-rate shock diagnostics:\n')
...
fprintf('\nExtended-sample (pre-COVID) A.2 analogue:\n')
disp(Table_A2_ext)
...
fprintf('\nExtended-sample (pre-COVID) A.4 analogue:\n')
disp(Table_A4_ext)
...
fprintf('\nBaseline versus extended sample (pre-COVID):\n')
fprintf('                                 Baseline       Extended (pre-COVID)\n')
...
fprintf('\nChange in A.2 analogue: extended (pre-COVID) - baseline\n')
disp(Table_A2_change)

fprintf('\nChange in A.4 analogue: extended (pre-COVID) - baseline\n')
...
xlabel('Quarters')
ylabel('%')
legend('1985Q1-2013Q2','1985Q1-2019Q4','Location','best')
grid on
...
results_ext.sample_end = 2019 + 3/4;
...
save(fullfile(folder,'results','ext_sample_1.precovid.mat'), ...
    'results_ext')